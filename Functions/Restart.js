...
async function restart(client, status) {
    const embed = new EmbedBuilder()
        ...
        .setFooter({ text: `Atenciosamente, Equipe Storm Apps - Updates`, iconURL: `https://cdn.discordapp.com/icons/1187759065456201749/a_02ee22c19b4a5c1e403bf30f1911be22.gif?size=2048&` })
        .setTimestamp()
